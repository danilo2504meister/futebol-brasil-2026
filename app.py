...
# ========================
    ...
    for _, row in df.iterrows():
        ...
        col1.write(row["MANDANTE"])
        col2.write(f"{row['GM']} x {row['GV']}")
        col3.write(row["VISITANTE"])
...
# ========================
    ...
    def zebra(x):
        return ['background-color: #f2f2f2' if x.name % 2 == 0 else '' for _ in x]
    ...
    MD - Média sofridos | CL SH - Clean Sheets
    """)
